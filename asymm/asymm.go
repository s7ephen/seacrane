...
Commands to implement:
 ...
 - List loaded pubkey
 - Generate keypair
 - Write Keypairs to files. 
 - Encrypt Message to recipient (from loaded pubkey list)
 - Encrypt File to recipient (from loaded pubkey list)
 - Write pubkeys to keyring file.
 - Load pubkeys from keyring file.
*/
